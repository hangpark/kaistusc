...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('chapter_type', models.CharField(choices=[('SUPPL', '부칙'), ('PRE', '전문'), ('CHAP', '장'), ('SEC', '절')], max_length=8, verbose_name='종류')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('revision_type', models.CharField(choices=[('ESTAB', '제정'), ('FULL', '전부개정'), ('PART', '일부개정')], max_length=8, verbose_name='제개정 종류')),
