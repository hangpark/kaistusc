    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(choices=[(0, '기본'), (1, '사업')], default=0, verbose_name='보드 역할')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('post_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='board.Post')),
                ('status', models.IntegerField(choices=[(0, '항상'), (1, '완료'), (2, '파기'), (3, '진행중')], default=0, verbose_name='프로젝트 진행 상태')),
