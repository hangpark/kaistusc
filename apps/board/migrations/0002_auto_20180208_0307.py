# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2018-02-08 03:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link', models.URLField(blank=True, max_length=500, verbose_name='소통창구 링크')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('embed_link', models.TextField(blank=True, verbose_name='웹 문서 삽입 링크')),
